...
public class Verification_JPetStore_Test_A1EE8AE20C732AEEDB3BB43362326465 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.datacorrelation.execution.http.HTTPActionAdapter", "com.ibm.rational.test.lt.execution.http.impl.HTTPAction");
    ...
    private IContentVPElement contVPElem_0 = new ContentVPElement("submenu menu vertical", 
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public Verification_JPetStore_Test_A1EE8AE20C732AEEDB3BB43362326465(IContainer container, String invocationId) {
		super(container, "Verification_JPetStore", invocationId, "A1EE8AE20C732AEEDB3BB43362326465", "/Module1/Verification_JPetStore.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new HTTPPageTitleVPEvent(), new RPTContinueEvent("Page title verification failed"), 1, "Page title verification failed"));
	...
	this.add(page_6(this));
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: Verification_JPetStore_Test_A1EE8AE20C732AEEDB3BB43362326465 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	private KAction dataTransform(IContainer parent) {
		...
		action.setMapFile("A1EE8AE20C732AEEDB3BB43362326465");
...
private HTTPPage page_1(final IContainer parent) {
	...
	req.addVerificationPoint(new HTTPMessageSizeVP(20231, 24725, null, 0));
		SubstitutableHTTPContentVP localContentVp_0 = new SubstitutableHTTPContentVP(0, true, null, 0, reqAction);
	...
	private void postDataClass_1(HTTPPostData postData) {
					String requestData_1 = MetaString.encode(ZipEntryProxy.asXMLFragment(
	                                   "A1EE8AE20C732AEEDB3BB43362326465.testdata",
