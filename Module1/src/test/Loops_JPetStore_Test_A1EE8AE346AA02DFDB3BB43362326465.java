...
public class Loops_JPetStore_Test_A1EE8AE346AA02DFDB3BB43362326465 extends LTTestScript  {
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public Loops_JPetStore_Test_A1EE8AE346AA02DFDB3BB43362326465(IContainer container, String invocationId) {
		super(container, "Loops_JPetStore", invocationId, "A1EE8AE346AA02DFDB3BB43362326465", "/Module1/Loops_JPetStore.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new HTTPPageTitleVPEvent(), new RPTContinueEvent("Page title verification failed"), 1, "Page title verification failed"));
	...
	this.add(confCon_1(this));
		...
		loopNm_1.addVarsToInit(Arrays.asList((IKDCCoreVar)vars[0]));
			...
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: Loops_JPetStore_Test_A1EE8AE346AA02DFDB3BB43362326465 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	private KAction dataTransform(IContainer parent) {
		...
		action.setMapFile("A1EE8AE346AA02DFDB3BB43362326465");
...
private VariableAction varAction_1(final IContainer parent) {
	...
	private For Loop_1(IContainer parent) {
		For forLoop = new For(parent,
				 "Loop1",
				 "A1EE8AE359BB4B00DB3BB43362326465",
				 0,
				 0,
				 0,
				 2,
...
private HTTPPage page_1(final IContainer parent) {
	...
	private void postDataClass_1(HTTPPostData postData) {
					String requestData_1 = MetaString.encode(ZipEntryProxy.asXMLFragment(
	                                   "A1EE8AE346AA02DFDB3BB43362326465.testdata",
